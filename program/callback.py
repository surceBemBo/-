            ...
            [
                [
                    InlineKeyboardButton(
                        "🐥قنـــــــاه الـــســـورس🐥", url="https://t.me/gebreelyad",
                    )
                ],
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "🪐 قناة البوت", url=f"https://t.me/gebreelyad"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
async def cbguides(_, query: CallbackQuery):
    await query.answer("طريقة استخدام البوت")
    await query.edit_message_text(
        f""" لاستخدام هذا البوت اتبع الاوامر:

 1 ↤ أولاً ، ضفني إلى مجموعتك
...
async def cbcmds(_, query: CallbackQuery):
    ...
    await query.edit_message_text(
        f"""» **قم بالضغط علي الزر الذي تريده لمعرفه الاوامر لكل!**
