...
async def start_(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""🦦 **منور يا خيا » {message.from_user.mention()} !**\n
🐰 **انا استطيع تشغيل الموسيقي والفديو في محادثتك الصوتية**

🦥 تعلم طريقة التشغيل واوامر التحكم بي عن طريق ». 🦥 الاوامر  ∆

🚶‍♂️ لتعلم طريقة تشغيلي بمجموعتك اضغط علي » 🚶‍♂️طريقة التفعيل ∆
""",
...
@Client.on_message(command(["برمج السورس", f"ؤمن", f"ورس", f"لسورس", f"ونا", f"جبريل"]) & filters.group & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/40e71832884764f066974.jpg",
        caption=f""" ✦╍━━𝑺𝑶𝑼𝑹𝑪𝑬   𝑮𝑷𝑹𝑬𝑳━┅✦ """,
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("آلِٰـِۢجِٰـِۢﯛ‌୭ڪِٰـِۢر", url=f"https://t.me/elbabayakelab"),
            ],
            [
                InlineKeyboardButton(
                    "𝑮𝑩𝑹𝑬𝑳 𝐌𝐔𝐒𝐈𝐂🐥", url=f"https://t.me/gebreelyad"
                ),
            ],
            [
                InlineKeyboardButton("🐥اضف البوت الى مجموعتك🐥", url=f"https://t.me/Gebreel_1111bot?startgroup=true"),
            ]
         ]
     )
  )
